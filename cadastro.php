...
<body>
    <div id="interface">
        ...
        <form id="formu" method="POST" action="users/cadastro.php">
            <fieldset id="Login">
                <legend>Cadastro</legend>
                <p>
                    <label for="nome_ident">Usuário:</label>
                <p>
                    <input type="text" name="user" id="label" size="20" maxlength="30" placeholder="Usuário" required />
                <p>
                    <label for="password">Senha:</label>
                <p>
                    <input type="password" name="senha" id="label" size="8" maxlength="10" placeholder="Senha" required />
                <p>
                    <label for="user">Tipo de usuário:</label>
                <p>
                    <select name="tuser" id="usuario" required>
